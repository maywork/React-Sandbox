...
function HookForm() {
  ...
  const emailState = useInputState('email@hooked.go')
  ...
  return (
    <div>
      <form onSubmit={handleSubmit} className="p-4">
        ...
        <br />
        <input {...emailState} className="rounded-md p-1 mb-2 text-center" placeholder="Please, enter your email" type="email" name="email" />
        <br />
